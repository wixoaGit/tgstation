...
#define SMOOTH_TRUE		(1<<0)
#define SMOOTH_MORE		(1<<1)
...
/proc/smooth_icon(atom/A)
	...
	if(A.smooth & (SMOOTH_TRUE | SMOOTH_MORE))
		...
		if(A.smooth & SMOOTH_DIAGONAL)
			...
			cardinal_smooth(A, adjacencies)//not_actual
		else
...
/turf/closed/wall/diagonal_smooth(adjacencies)
	...
	if(adjacencies)
		...
		var/mutable_appearance/underlay_appearance = mutable_appearance(layer = TURF_LAYER)//not_actual
