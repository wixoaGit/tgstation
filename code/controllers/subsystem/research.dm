SUBSYSTEM_DEF(research)
	...
	//)
	var/list/techweb_point_items = list()//not_actual
...
/datum/controller/subsystem/research/proc/calculate_server_coefficient()
	//var/amt = servers.len
	var/amt = 0//not_actual
	if(!amt)
		return 0
	var/coeff = 100
